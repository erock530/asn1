...
func marshalField(out *forkableWriter, v reflect.Value, params fieldParameters) (err error) {
	...
	if v.Type() == rawValueType {
		...
		if tag == tagPrintableString && params.stringType == 0 {
			//This is a string without an explicit string type.  Use PrintableString
			//if the character set allows it, otherwise use UTF8String
...
//MarshalWithParams marshals the given value with the specified custom paramter
